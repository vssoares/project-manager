...
import { generateCpf, generateMany } from '../../data-access/generators'
...
@Component({
  ...
  template: `
    <app-generator-shell
      ...
      description="Gera CPFs válidos com dígitos verificadores corretos. Uso apenas para testes."
      [results]="results()"
      (generate)="onGenerate()"
    >
...
export class CpfPage {
  ...
  onGenerate(): void {
    this.results.set(generateMany(this.count, () => generateCpf(this.masked)))
  }
}
